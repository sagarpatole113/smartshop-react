      ...
      <BrowserRouter>
        <nav className="navbar navbar-expand-lg navbar-light bg-light ">
          <div className="container-fluid">
            ...
            <img src="images/Capture1.JPG" style= {{width:"200px"}} alt="img" className="logo" />
            ...
            <div className="collapse navbar-collapse" id="navbarNav">
              <ul className="navbar-nav">
                ...
                <li className="nav-item3">
                  ...
                  <img src="images/wishlist2.jpg" alt="img" className="logo12" />{cartItems.length}
                  </Link>
                </li>
                <li><h5><Link className="nav-link" to="/showcart">
                   <img src="images/cart.png" alt="img" className="logo1" />
                  </Link></h5>
                  </li>
              </ul>
            </div>
